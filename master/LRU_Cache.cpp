...
int LRU_Cache::synchronize_HashmapOfPtr(const DISK_READ_THREAD_STATE& dstate, cudaStream_t stream)
{
	...
	if (dstate >= DISK_READ_THREAD_CENTER_LFU_EVEN_FIELD_READ_COMPLETE) {
